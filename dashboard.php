	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="panel panel-container">
			...
			<div class="col-xs-6 col-md-3 col-lg-3 no-padding">
					<a href="http://localhost:3000/index.php?room_mang">
				...
				<div class="col-xs-6 col-md-3 col-lg-3 no-padding">
				<a href="http://localhost:3000/index.php?reservation">
				...
				<div class="col-xs-6 col-md-3 col-lg-3 no-padding">
				<a href="http://localhost:3000/index.php?staff_mang">
				...
				<div class="col-xs-6 col-md-3 col-lg-3 no-padding">
					 <a href="http://localhost:3000/index.php?complain">
			...
			<div class="row">
				<div class="col-xs-6 col-md-3 col-lg-3 no-padding">
				<a href="http://localhost:3000/index.php?booked_rooms">
					<div class="panel panel-teal panel-widget border-right">
				...
				<div class="col-xs-6 col-md-3 col-lg-3 no-padding">
				 <a href="http://localhost:3000/index.php?available_rooms">
				 <div class="panel panel-blue panel-widget border-right">
				...
				<div class="col-xs-6 col-md-3 col-lg-3 no-padding">
					 <a  href="http://localhost:3000/index.php?check_in">
					 <div class="panel panel-orange panel-widget border-right">
